...
class DataTransformation:
    ...
    def data_transforemer_object(self):
        '''
            This method is used to create a preprocessor object which will be used to transform the data
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            preprocessor = self.data_transforemer_object()
            ...
            logging.info("Applying the preprocessor object on the train data")
